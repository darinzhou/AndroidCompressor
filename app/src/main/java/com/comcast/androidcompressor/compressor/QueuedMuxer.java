...
public class QueuedMuxer {
    ...
    private void onSetOutputFormat() {
        ...
        try {
            ...
            Log.v(TAG, "Added track #" + mVideoTrackIndex + " with " + mVideoFormat.getString(MediaFormat.KEY_MIME) + " to muxer...Failed!");
        }
        ...
        try {
            ...
            Log.v(TAG, "Added track #" + mAudioTrackIndex + " with " + mAudioFormat.getString(MediaFormat.KEY_MIME) + " to muxer...Failed!");
        }
